...
vector<PseudoJet> generate_particles(int num_particles) {
    ...
    random_device rd;
    mt19937 gen(rd());
    uniform_real_distribution<> dis_px(-10.0, 10.0);
    uniform_real_distribution<> dis_py(-0.1, 0.1);
    uniform_real_distribution<> dis_energy(50.0, 100.0);
...
int main() {
    ...
    cout<< "No. of particles: " <<num_particles <<endl;
